...
toolbox.router.get(/^https:\/\/delivery-v3\.localhost\.com\/assets\/fonts/, toolbox.cacheFirst, {"debug":true,"cache":{"maxEntries":10,"name":"assets-cache","maxAgeSeconds":180}});
toolbox.router.get(/^https:\/\/erpnet-v5\.ilhanet\.com\/erpnet-api/, toolbox.fastest, {"debug":true});
toolbox.router.get(/^https:\/\/storage\.googleapis\.com\/ilhanet-140808\.appspot\.com/, toolbox.cacheFirst, {"debug":true,"cache":{"maxEntries":10,"name":"ilhanet-140808-cache","maxAgeSeconds":180}});
